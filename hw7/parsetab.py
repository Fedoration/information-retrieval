...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression','hw7.py',35),
  ('expression -> expression MINUS term','expression',3,'p_expression','hw7.py',36),
  ('expression -> term','expression',1,'p_expression_term','hw7.py',46),
  ('term -> term TIMES factor','term',3,'p_term','hw7.py',53),
  ('term -> term DIVIDE factor','term',3,'p_term','hw7.py',54),
  ('term -> factor','term',1,'p_term_factor','hw7.py',64),
  ('factor -> NUMBER','factor',1,'p_factor_number','hw7.py',71),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_group','hw7.py',78),
]
